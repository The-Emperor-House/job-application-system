...
const statuses: ApplicationStatus[] = ["PENDING", "REVIEWING", "INTERVIEW", "OFFERED", "REJECTED", "HIRED"];
...
export default async function ApplicationsPage({
  ...
  const applications = await authApi<JobApplication[]>(`/api/applications${query}`);
